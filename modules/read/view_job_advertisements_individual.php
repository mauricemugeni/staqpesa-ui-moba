...
$users = new Users();
$code = $_GET['code'];
$_SESSION['job_advertisement'] = $code;
$details = $users->fetchJobAdvertisementDetails($code);
                        ...
                        <div class="panel-body">
                            <div class="action">
                                <?php if (($details['createdby'] != $_SESSION['userid'] AND $details['status'] == 1001) OR ( $details['lastmodifiedby'] != $_SESSION['userid'] AND $details['status'] == 1032)) { ?>
                                    <a class="edit-individual" href="?update_job_advertisement&update_type=accept_approval&code=" <?php echo $code; ?> >
                                        Accept Approval
                                    </a>
                                    <a class="edit-individual-warning" href="?update_job_advertisement&update_type=reject_approval&code=" <?php echo $code; ?> >
                                        Reject Approval
                                    </a>
                                    <?php
                                }
                                if ($details['status'] == 1020) {
                                    ?>
                                    <a class="edit-individual" href="?update_job_advertisement&update_type=activate&code=" <?php echo $code; ?> >
                                        Activate
                                    </a>
                                <?php } if ($details['status'] == 1021) { ?>
                                    <a class="edit-individual-warning" href="?update_job_advertisement&update_type=deactivate&code=" <?php echo $code; ?> >
                                        Deactivate
                                    </a>
                                <?php } if ($details['status'] != 1000) { ?>
                                    <a class="edit-individual-warning" href="?update_job_advertisement&update_type=delete&code=" <?php echo $code; ?> >
                                        Delete
                                    </a>
                                    <?php
                                }
                                ...
                                if ($details['status'] != 1032) {
                                    ?>
                                    <a class="edit-individual" href="?update_job_advertisement&update_type=edit&code=" <?php echo $code; ?> >
                                        Edit
                                    </a>
                                <?php } ?>
                            </div>
                            <div class="status-element">
                                <div class="form-group">
                                    ...
                                    <span class="form-control"><?php echo $details['institution']; ?></span>
                                </div>
                                <div class="form-group">
                                    <label for="title">Job Title:</label>
                                    <span class="form-control"><?php echo $details['title']; ?></span>
                                </div>
                                <div class="form-group">
                                    <label for="job_description">Job Description:</label>
                                    <span class="form-control"><?php echo $details['job_description']; ?></span>
                                </div>
                                <div class="form-group">
                                    <label for="tasks">Tasks:</label>
                                    <span class="form-control"><?php echo $details['tasks']; ?></span>
                                </div>
                                <div class="form-group">
                                    <label for="employment_type">Employment Type:</label>
                                    <span class="form-control"><?php echo $details['employment_type']; ?></span>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="form-control"><?php echo $details['required_education']; ?></span>
                                </div>
                                <div class="form-group">
                                    <label for="required_skills">Required Skills:</label>
                                    <span class="form-control"><?php echo $details['required_skills']; ?></span>
                                </div>
                                <div class="form-group">
                                    <label for="required_experience">Required Experience:</label>
                                    <span class="form-control"><?php echo $details['required_experience']; ?></span>
                                </div>
                                <div class="form-group">
                                    <label for="compensation_currency">Compensation Currency:</label>
                                    <span class="form-control"><?php echo $details['compensation_currency']; ?></span>
                                </div>
                                <div class="form-group">
                                    <label for="compensation_amount">Compensation Amount:</label>
                                    <span class="form-control"><?php echo $details['compensation_amount']; ?></span>
                                </div>
                                <div class="form-group">
                                    <label for="other_benefits">Other Benefits:</label>
                                    <span class="form-control"><?php echo $details['other_benefits']; ?></span>
                                </div>
                                <div class="form-group">
                                    <label for="application_deadline">Application Deadline:</label>
                                    <span class="form-control"><?php echo $details['application_deadline']; ?></span>
                                </div>
                                <div class="form-group">
