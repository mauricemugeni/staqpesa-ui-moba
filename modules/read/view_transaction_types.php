                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <table class="table table-striped">
                                <tr>
                                    <th>Name</th>
                                    <th>Charge <?php echo '(' . $_SESSION['currency'] . ')'; ?></th>
                                    <th>Created At</th>
                                    <th>Created By</th>
                                    <th>Status</th>
                                </tr>
                                ...
                                if (!empty($_POST)) {
                                    ...
                                    $info = $settings->getAllTransactionTypeNotifications();
                                } else {
                                    $info = $settings->getAllTransactionTypes();
                                }
                                ...
                                if (count($info) == 0) {
                                    ...
                                    foreach ($info as $data) {
                                        ...
                                        echo '<tr>';
                                        echo "<td> <a href='?view_transaction_types_individual&code=" . $data['id'] . "'>" . $data['name'] . '</td>';
                                        echo '<td>' . number_format($data['charge'], 2) . '</td>';
