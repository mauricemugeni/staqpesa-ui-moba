...
$users = new Users();
$code = $_GET['code'];
$_SESSION['loan_type'] = $code;
$details = $loans->fetchLoanTypeDetails($code);
$instalment_frequency_details = $loans->fetchInstalmentFrequencyDetails($details['instalment_frequency']);
                        ...
                        <div class="panel-body">
                            <div class="action">
                                <?php if (($details['createdby'] != $_SESSION['userid'] AND $details['status'] == 1001) OR ( $details['lastmodifiedby'] != $_SESSION['userid'] AND $details['status'] == 1032)) { ?>
                                    <a class="edit-individual" href="?update_loan_type&update_type=accept_approval&code=" <?php echo $code; ?> >
                                        Accept Approval
                                    </a>
                                    <a class="edit-individual-warning" href="?update_loan_type&update_type=reject_approval&code=" <?php echo $code; ?> >
                                        Reject Approval
                                    </a>
                                    <?php
                                }
                                if ($details['status'] == 1020) {
                                    ?>
                                    <a class="edit-individual" href="?update_loan_type&update_type=activate&code=" <?php echo $code; ?> >
                                        Activate
                                    </a>
                                <?php } if ($details['status'] == 1021) { ?>
                                    <a class="edit-individual-warning" href="?update_loan_type&update_type=deactivate&code=" <?php echo $code; ?> >
                                        Deactivate
                                    </a>
                                <?php } if ($details['status'] != 1000) { ?>
                                    <a class="edit-individual-warning" href="?update_loan_type&update_type=delete&code=" <?php echo $code; ?> >
                                        Delete
                                    </a>
                                    <?php
                                }
                                ...
                                if ($details['status'] != 1032) {
                                    ?>
                                    <a class="edit-individual" href="?update_loan_type&update_type=edit&code=" <?php echo $code; ?> >
                                        Edit
                                    </a>
                                <?php } ?>
                            </div>
                            ...
                            <div id="status-element">
                                ...
                                <div class="form-group">
                                    <label for="qualification_time">Qualification Time:</label>
                                    <span class="form-control"><?php echo $details['qualification_time'] . " MONTH(S)"; ?></span>
                                </div>
                                <div class="form-group">
                                    <label for="qualification_amount">Qualification Amount <?php echo '(' . $_SESSION['currency'] . ')'; ?>:</label>
                                    <span class="form-control"><?php echo $_SESSION['currency']. " ." . $details['qualification_amount']; ?> </span>
                                </div>
                                <div class="form-group">
                                    <label for="interest_rate">Interest Rate:</label>
                                    <span class="form-control"><?php echo $details['interest_rate'] . "%"; ?></span> 
                                </div>
                                <div class="form-group">
                                    <label for="maximum_duration">Maximum Duration:</label>
                                    <span class="form-control"><?php echo $details['maximum_duration'] . " MONTH(S)"; ?></span>
                                </div>
                                <div class="form-group">
                                    <label for="instalment_frequency">Instalment Frequency:</label>
                                    <span class="form-control"><?php echo $instalment_frequency_details['name']; ?></span>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="form-control"><?php echo $details['default_rate'] . "%"; ?> </span>
                                </div>
                                <div class="form-group">
