                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <table class="table table-striped">
                                ...
                                } else if (is_menu_set('view_investor_types_notifications') != "") {
                                    $info = $funding->getAllInvestorTypeNotifications();
                                } else {
                                    $info = $funding->getAllInvestorTypes();
                                }
                                ...
                                if (count($info) == 0) {
                                    ...
                                    foreach ($info as $data) {
                                        ...
                                        echo "<tr>";
                                        echo "<td> <a href='?view_investor_types_individual&code=" . $data['id'] . "'>" . $data['id'] . "</td>";
