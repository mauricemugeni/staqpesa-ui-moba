...
$funding_type_details = $funding->fetchFundingTypeDetails($details['funding_type']);
$financing_method_details = $funding->fetchFinancingMethodDetails($details['financing_method']);
                        ...
                        <div class="panel-body">
                            <div class="action">
                                <?php if ($_SESSION['logged_in_user_type_details']['name'] != "INVESTOR") { ?>
                                    <?php if (($details['createdby'] != $_SESSION['userid'] AND $details['status'] == 1001) OR ( $details['lastmodifiedby'] != $_SESSION['userid'] AND $details['status'] == 1032)) { ?>
                                        <a class="edit-individual" href="?update_project&update_type=accept_approval&code=<?php echo $code; ?>" >
                                            Accept Approval
                                        </a>
                                        <a class="edit-individual-warning" href="?update_project&update_type=reject_approval&code=<?php echo $code; ?>" >
                                            Reject Approval
                                        </a>
                                        <?php
                                    }
                                    if ($details['status'] == 1020) {
                                        ?>
                                        <a class="edit-individual" href="?update_project&update_type=activate&code=<?php echo $code; ?>" >
                                            Activate
                                        </a>
                                    <?php } if ($details['status'] == 1021) { ?>
                                        <a class="edit-individual-warning" href="?update_project&update_type=deactivate&code=<?php echo $code; ?>" >
                                            Deactivate
                                        </a>
                                    <?php } if ($details['status'] != 1000) { ?>
                                        <a class="edit-individual-warning" href="?update_project&update_type=delete&code=<?php echo $code; ?>" >
                                            Delete
                                        </a>
                                        <?php
                                    }
                                    ...
                                    if ($details['status'] != 1032) {
                                        ?>
                                        <a class="edit-individual" href="?update_project&update_type=edit&code=<?php echo $code; ?>" >
                                            Edit
                                        </a>
                                    <?php }
                                }
                                ?>
                                <a class="edit-individual" href="?view_bids_on_project&code=<?php echo $code; ?>" >
                                    View Bids
                                </a>
                            </div>
                            <div class="status-element">
                                <div class="form-group">
                                    ...
                                    <span class="form-control"><?php echo $details['owner']; ?></span>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="form-control"><?php echo $details['business_plan']; ?></span>
                                </div>
                                <div class="form-group">
                                    <label for="funding_type">Funding Type:</label>
                                    <span class="form-control"><?php echo $funding_type_details['name']; ?></span>
                                </div>
                                <div class="form-group">
