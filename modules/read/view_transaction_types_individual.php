...
$code = $_GET['code'];
$_SESSION['transaction_type'] = $code;
                        ...
                        <div class="panel-body">
                            <div class="action">
                                <?php if (($details['createdby'] != $_SESSION['userid'] AND $details['status'] == 1001) OR ( $details['lastmodifiedby'] != $_SESSION['userid'] AND $details['status'] == 1032)) { ?>
                                    <a class="edit-individual" href="?update_transaction_type&update_type=accept_approval&code=" <?php echo $code; ?> >
                                        Accept Approval
                                    </a>
                                    <a class="edit-individual-warning" href="?update_transaction_type&update_type=reject_approval&code=" <?php echo $code; ?> >
                                        Reject Approval
                                    </a>
                                    <?php
                                }
                                if ($details['status'] == 1020) {
                                    ?>
                                    <a class="edit-individual" href="?update_transaction_type&update_type=activate&code=" <?php echo $code; ?> >
                                        Activate
                                    </a>
                                <?php } if ($details['status'] == 1021) { ?>
                                    <a class="edit-individual-warning" href="?update_transaction_type&update_type=deactivate&code=" <?php echo $code; ?> >
                                        Deactivate
                                    </a>
                                <?php } if ($details['status'] != 1000) { ?>
                                    <a class="edit-individual-warning" href="?update_transaction_type&update_type=delete&code=" <?php echo $code; ?> >
                                        Delete
                                    </a>
                                    <?php
                                }
                                ...
                                if ($details['status'] != 1032) {
                                    ?>
                                    <a class="edit-individual" href="?update_transaction_type&update_type=edit&code=" <?php echo $code; ?> >
                                        Edit
                                    </a>
                                <?php } ?>
                            </div>
                            ...
                            <div id="status-element">
                                ...
                                <div class="form-group">
                                    <label for="charge">Charge <?php echo '(' . $_SESSION['currency'] . ')'; ?>:</label>
                                    <span class="form-control"><?php echo $_SESSION['currency'] . " ." . number_format($details['charge'], 2); ?> </span>
                                </div>
                                <div class="form-group">
