...
$users = new Users();
$loans = new Loans();
unset($_SESSION['instalment_frequency']);
                        ...
                        <div class="panel-body">
                            <table class="table table-striped">
                                ...
                                if (!empty($_POST)) {
                                    ...
                                    $info = $loans->getAllInstalmentFrequencyNotifications();
                                } else {
                                    $info = $loans->getAllInstalmentFrequencies();
                                }
                                ...
                                if (count($info) == 0) {
                                    ...
                                    foreach ($info as $data) {
                                        ...
                                        echo '<tr>';
                                        echo "<td> <a href='?view_instalment_frequencies_individual&code=" . $data['id'] . "'>" . $data['name'] . '</td>';
