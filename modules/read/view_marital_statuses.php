                        ...
                        <div class="panel-body">
                            <table class="table table-striped">
                                ...
                                if (!empty($_POST)) {
                                    ...
                                    $info = $settings->getAllMaritalStatusNotifications();
                                } else {
                                    $info = $settings->getAllMaritalStatuses();
                                }
                                ...
                                if (count($info) == 0) {
                                    ...
                                    foreach ($info as $data) {
                                        ...
                                        echo '<tr>';
                                        echo "<td> <a href='?view_marital_statuses_individual&code=" . $data['id'] . "'>" . $data['name'] . '</td>';
