                        ...
                        <div class="panel-body">
                            <table class="table table-striped">
                                ...
                                if (!empty($_POST) AND ! isset($_POST['create_pdf'])) {
                                    ...
                                    $info = $users->getAllIndividualAccountAccountHolderOccupations();
                                } else {
...
//                                        }
                                        ...
                                        $account_holder_details = $users->fetchAccountHolderDetails($data['account_holder_id']);
                                        $account_holder_name = $account_holder_details['firstname'] . " " . $account_holder_details['lastname'];

                                        echo '<tr>';
                                        echo "<td> <a href='?view_account_holder_occupations_individual&code=" . $data['id'] . "'>" . $account_holder_name . '</td>';
                                        echo '<td>' . $account_holder_details['account_number'] . '</td>';
