...
$users = new Users();
$funding = new Funding();
unset($_SESSION['financing_method']);
                        ...
                        <div class="panel-body">
                            <table class="table table-striped">
                                ...
                                if (!empty($_POST)) {
                                    ...
                                    $info = $funding->getAllFinancingMethodNotifications();
                                } else {
                                    $info = $funding->getAllFinancingMethods();
                                }
                                ...
                                if (count($info) == 0) {
                                    ...
                                    foreach ($info as $data) {
                                        ...
                                        echo "<tr>";
                                        echo "<td> <a href='?view_financing_methods_individual&code=" . $data['id'] . "'>" . $data['id'] . "</td>";
