                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <table class="table table-striped">
                                ...
                                } else if (is_menu_set('view_nationalities_notifications') != "") {
                                    $info = $settings->getAllNationalityNotifications();
                                } else {
                                    $info = $settings->getAllNationalities();
                                }
                                ...
                                if (count($info) == 0) {
                                    ...
                                    foreach ($info as $data) {
                                        ...
                                        echo '<tr>';
                                        echo "<td> <a href='?view_nationalities_individual&code=" . $data['id'] . "'>" . $data['name'] . '</td>';
