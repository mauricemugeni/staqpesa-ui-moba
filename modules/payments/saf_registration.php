...
$shortcode = '654019';
$consumerkey = "JZD1uqiGXBeletNDQzxpUJPnpz2IbH5y";
$consumersecret = "OdUGjxutLSurHIuc";
$validationurl = "http://ui.ictinnovators-coop.com/?saf_validation&token=IP1962mm";
$confirmationurl = "http://ui.ictinnovators-coop.com/?saf_confirmation&token=IP1962mm";

// comment the below two lines if on production environment
//    $authenticationurl='https://sandbox.safaricom.co.ke/oauth/v1/generate?grant_type=client_credentials';
//    $registerurl = 'https://sandbox.safaricom.co.ke/mpesa/c2b/v1/registerurl';

// un-comment the below two lines if you are in production 
