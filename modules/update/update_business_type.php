...
if ($update_type == "edit") {
    ...
    $success = $settings->updateBusinessType($code, $update_type);
    if (is_bool($success) && $success == true) {
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form role="form" method="POST">
                                <input type="hidden" name="action" value="edit_business_type"/>
                                <input type="hidden" name="createdby" value="<?php echo $_SESSION['userid']; ?>">
                                <div class="form-group">
                                    <label for="name">Business Type</label>
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Business Type" value="<?php echo $details['name']; ?>" required="yes"/>
                                </div>
