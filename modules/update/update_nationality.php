...
if ($update_type == "edit") {
    if (!empty($_POST)) {
        ...
        App::redirectTo("?view_nationalities");
    }
} else {
    $success = $settings->updateNationality($code, $update_type);
    if (is_bool($success) && $success == true) {
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form role="form" method="POST">
                                <input type="hidden" name="action" value="edit_nationality"/>
                                <input type="hidden" name="createdby" value="<?php echo $_SESSION['userid']; ?>">
                                <div class="form-group">
                                    <label for="name">Nationality</label>
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Nationality" value="<?php echo $details['name']; ?>" required="yes"/>
                                </div>
