! function(t, e) {
        ...
        h = function() {
            return {
                move: function(t, e, o, n) {
                    var a, r = .3,
                        l = 180;
                    t.style.transform = "translateX(" + n + "px)", n > 0 ? (a = (l - n) / l, r > a && e.hide(g(o, {
                        transitionOut: "fadeOutRight",
                        transitionOutMobile: "fadeOutRight"
                    }), t, "drag")) : (a = (l + n) / l, r > a && e.hide(g(o, {
            ...
            var i = t.querySelector("." + o + "-progressbar div"),
                ...
                r = {
                    ...
                    updateProgress: function() {
                        if (a.Paused = !!t.classList.contains(o + "-paused"), a.Reseted = !!t.classList.contains(o + "-reseted"), a.Closed = !!t.classList.contains(o + "-closed"), a.Reseted && (clearInterval(s), i.style.width = "100%", y(t, e, n), t.classList.remove(o + "-reseted")), a.Closed && (clearInterval(s), t.classList.remove(o + "-closed")), !a.Paused && !a.Reseted && !a.Closed) {
                            r.currentTime = r.currentTime + 10;
                            var l = (r.hideEta - r.currentTime) / r.maxHideTime * 100;
                            i.style.width = l + "%", (Math.round(l) < 0 || "object" != typeof t) && (clearInterval(s), n.apply())
                        }
                    }
                };
            e.timeout && (r.maxHideTime = parseFloat(e.timeout), r.hideEta = (new Date).getTime() + r.maxHideTime, s = setInterval(r.updateProgress, 10))
        };
    return e.destroy = function() {
        m(document.querySelectorAll("." + o + "-wrapper"), function(t, e) {
            ...
            t.remove()
        }), document.removeEventListener(o + "-opened", {}, !1), document.removeEventListener(o + "-opening", {}, !1), document.removeEventListener(o + "-closing", {}, !1), document.removeEventListener(o + "-closed", {}, !1), c = {}
        ...
        e.parentNode.style.height = a + "px", e.style.pointerEvents = "none", (!n || window.innerWidth > d) && (e.parentNode.style.transitionDelay = "0.2s");
        try {
            s.closedBy = i;
            var r = new CustomEvent(o + "-closing", {
                detail: s,
                bubbles: !0,
                cancelable: !0
            });
        ...
        setTimeout(function() {
            e.parentNode.style.height = "0px", e.parentNode.style.overflow = "", window.setTimeout(function() {
                ...
                "undefined" != typeof s.onClosed && s.onClosed.apply(null, [s, e, i])
            }, 1e3)
        }, 200), "undefined" != typeof s.onClosing && s.onClosing.apply(null, [s, e, i])
    }, e.show = function(t) {
        var e = this,
            i = g(c, t || {});
        if (i = g(u, i), i.toastOnce && i.id && document.querySelectorAll("." + o + "#" + i.id).length > 0) return !1;
        var s = {
        ...
        s.toast.appendChild(s.toastBody), s.toastCapsule.appendChild(s.toast),
            function() {
            ...
            function() {
                i.close ? (s.buttonClose = document.createElement("button"), s.buttonClose.classList.add(o + "-close"), s.buttonClose.addEventListener("click", function(t) {
                    t.target;
            ...
            function() {
                i.progressBar && i.timeout ? (s.progressBar = document.createElement("div"), s.progressBarDiv = document.createElement("div"), s.progressBar.classList.add(o + "-progressbar"), s.progressBarDiv.style.background = i.progressBarColor, s.progressBar.appendChild(s.progressBarDiv), s.toast.appendChild(s.progressBar), setTimeout(function() {
                    y(s.toast, i, function() {
                        e.hide(i, s.toast)
                    })
                }, 300)) : i.progressBar === !1 && i.timeout && setTimeout(function() {
                    e.hide(i, s.toast)
                }, i.timeout)
            }(),
            function() {
            ...
            function() {
                i.title.length > 0 && (s.strong = document.createElement("strong"), s.strong.appendChild(f(i.title)), s.toastBody.appendChild(s.strong), i.titleColor && (s.strong.style.color = i.titleColor), i.titleSize && (isNaN(i.titleSize) ? s.strong.style.fontSize = i.titleSize : s.strong.style.fontSize = i.titleSize + "px"), i.titleLineHeight && (isNaN(i.titleSize) ? s.strong.style.lineHeight = i.titleLineHeight : s.strong.style.lineHeight = i.titleLineHeight + "px"))
            }(),
            function() {
                i.message.length > 0 && (s.p = document.createElement("p"), s.p.appendChild(f(i.message)), s.toastBody.appendChild(s.p), i.messageColor && (s.p.style.color = i.messageColor), i.messageSize && (isNaN(i.titleSize) ? s.p.style.fontSize = i.messageSize : s.p.style.fontSize = i.messageSize + "px"), i.messageLineHeight && (isNaN(i.titleSize) ? s.p.style.lineHeight = i.messageLineHeight : s.p.style.lineHeight = i.messageLineHeight + "px"))
            }(), i.title.length > 0 && i.message.length > 0 && (s.strong.style.paddingRight = "10px"),
            function() {
                if (i.buttons.length > 0) {
                    s.buttons.classList.add(o + "-buttons"), i.message.length > 0 && (i.rtl ? s.p.style.marginLeft = "15px" : s.p.style.marginRight = "15px");
                    var t = 0;
                    m(i.buttons, function(o, n) {
                        s.buttons.appendChild(f(o[0]));
            ...
            function() {
                if (i.animateInside) {
                    ...
                    var t = [200, 100, 300];
                    if ("bounceInLeft" == i.transitionIn && (t = [400, 200, 400]), i.title.length > 0 && window.setTimeout(function() {
                            s.strong.classList.add("slideIn")
                        }, t[0]), i.message.length > 0 && window.setTimeout(function() {
                            s.p.classList.add("slideIn")
                        }, t[1]), i.icon && window.setTimeout(function() {
                            s.icon.classList.add("revealIn")
                        }, t[2]), i.buttons.length > 0 && s.buttons) {
                        var e = 150;
                        m(s.buttons.childNodes, function(t, o) {
            ...
            }(), i.onOpening.apply(null, [i, s.toast]);
        try {
            var l = new CustomEvent(o + "-opening", {
                detail: i,
                bubbles: !0,
                cancelable: !0
            });
        ...
        setTimeout(function() {
            ...
            i.onOpened.apply(null, [i, s.toast])
        }, 1e3), i.pauseOnHover && (s.toast.addEventListener("mouseenter", function(t) {
