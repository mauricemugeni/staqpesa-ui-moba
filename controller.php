...
// Component 122
else if (is_menu_set('view_account_business_data') != "") {
    $currentPage = WPATH . "modules/read/view_account_business_data.php";
    set_title($_SESSION['chapter_details']['chapter_name'] . " | Account Business Data");
}
...
//}
// Component 124
else if (is_menu_set('view_account_business_data_individual') != "") {
    $currentPage = WPATH . "modules/read/view_account_business_data_individual.php";
    set_title($_SESSION['chapter_details']['chapter_name'] . " | Account Business Data Details");
}
...
// Component 176
else if (is_menu_set('view_account_banking_details') != "") {
    $currentPage = WPATH . "modules/read/view_account_banking_details.php";
    set_title($_SESSION['chapter_details']['chapter_name'] . " | Banking Details");
}
...
// Component 289
else if (is_menu_set('view_account_banking_details_individual') != "") {
    $currentPage = WPATH . "modules/read/view_account_banking_details_individual.php";
    set_title($_SESSION['chapter_details']['chapter_name'] . " | Account Banking Details");
}

// Component 290
else if (is_menu_set('update_account_banking_details') != "") {
    $currentPage = WPATH . "modules/update/update_account_banking_details.php";
    set_title($_SESSION['chapter_details']['chapter_name'] . " | Update Account Banking Details");
}
...
// Component 290
else if (is_menu_set('update_account_holder_occupation') != "") {
    $currentPage = WPATH . "modules/update/update_account_holder_occupation.php";
    set_title($_SESSION['chapter_details']['chapter_name'] . " | Update Account Holder Occupation Details");
}
